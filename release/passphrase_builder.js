...
(function (root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    Rust.passphrase_builder = factory();
  }
})(undefined, function () {
  return function (module_factory) {
    ...
    if (typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string") {
      ...
      var wasm_path = path.join(__dirname, "passphrase_builder.wasm");
      var buffer = fs.readFileSync(wasm_path);
      var mod = new WebAssembly.Module(buffer);
      var wasm_instance = new WebAssembly.Instance(mod, instance.imports);
      return instance.initialize(wasm_instance);
    } else {
      var file = fetch("passphrase_builder.wasm", {
      ...
      return wasm_instance.then(function (wasm_instance) {
        ...
        console.log("Finished loading Rust wasm module 'passphrase_builder'");
        return exports;
      }).catch(function (error) {
        console.log("Error loading Rust wasm module 'passphrase_builder':", error);
        throw error;
      });
    }
  }(function () {
